...
public class PermissionsCommand
	...
	private void getPermissionGui(Player player, String permssion){
		int i = 0;
		for(Object permissible : Bukkit.getPluginManager().getPermissionSubscriptions(permssion).stream().filter(permissible -> permissible instanceof Player).collect(Collectors.toList())){
